...
#define HOTEND_OFFSET_X { 0.0, 60.0 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, -1.6 }  // (mm) relative Y-offset for each nozzle
#define HOTEND_OFFSET_Z { 0.0, 0.00 }  // (mm) relative Z-offset for each nozzle
...
&& TRONXY_PROJ != PROJ_X5SA500_PRO \
&& TRONXY_PROJ != PROJ_VEHO600 \
&& TRONXY_PROJ != PROJ_X5SA600 \
&& TRONXY_PROJ != PROJ_X5SA500_2E \
&& TRONXY_PROJ != PROJ_HS \
&& TRONXY_PROJ != PROJ_VEHO500 \
&& TRONXY_PROJ != PROJ_VEHO600_2E \
&& TRONXY_PROJ != PROJ_VEHO500_2E \
&& TRONXY_PROJ != PROJ_VEHO800 \
...
#if TRONXY_PROJ == PROJ_GEMINIS
#define X_TO_BED          -54
#define X2_TO_BED         50.3
#define HOTEND_TO_HOTEND  58.5
#elif TRONXY_PROJ == PROJ_GEMINIXS
#define X_TO_BED          -52
#define X2_TO_BED         50
#define HOTEND_TO_HOTEND  57.8
#elif TRONXY_PROJ == PROJ_GEMINID1
#define X_TO_BED          -18
#define X2_TO_BED         8
#define HOTEND_TO_HOTEND  60.0
#elif TRONXY_PROJ == PROJ_GEMINIX
#define X_TO_BED         -32
#define X2_TO_BED        32
#define HOTEND_TO_HOTEND 36
#else
// #define X_TO_BED         -54 //30->12 temp
#define X_TO_BED         0
#define X2_TO_BED        0
#define HOTEND_TO_HOTEND 0
#endif
...
|| TRONXY_PROJ == PROJ_GEMINIX
  ...
  #define Z_MAX_POS 1200
#elif TRONXY_PROJ == PROJ_GEMINID1
  #define Z_MAX_POS 280
#else
  #define Z_MAX_POS 200
#endif
#if TAOLI_SERIAL && defined(I_DRIVER_TYPE)
#define I_MIN_POS 0
#define I_MAX_POS 50
#endif
//#define J_MIN_POS 0
...
&& TRONXY_PROJ != PROJ_C2 \
&& TRONXY_PROJ != PROJ_CRUX1 \
&& TRONXY_PROJ != PROJ_MOORE2_PRO \
&& TRONXY_PROJ != PROJ_TAONI
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_RAISE_MIN   2   // Always raise Z by at least this distance
